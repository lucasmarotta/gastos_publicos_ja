    ...
    <div class="container">
        ...
        <div class="section-title">
            ...
            <div class="section-title-icon">
                <hr><span class="vue-star"></span><hr>
            </div>
        </div>
            ...
            @foreach($obras_mais_vistas as $mais_vista)
                <a href="/obras/{{$mais_vista->obra->id}}">
                    <div class="obra-container">
                        <div class="obra-uf">
                            <span class="br-uf-{{strtolower($mais_vista->obra->estado->sigla)}}"></span>
                        </div>
                        <div class="obra-info">
                            <h4>{{$mais_vista->obra->nome}}</h4>
                            <p><span class="br-brasil"></span> {{ $mais_vista->obra->estado->nome }}</p>
                            <p class="obra-value numeric">R${{number_format($mais_vista->obra->valor,2,',','.')}}</p>
                            <div class="obra-social-counter">
                                <span><span class="vue-twitter"></span> {{$mais_vista->twitterTotal}}</span>
                                <span><span class="vue-comment"></span> {{$mais_vista->disqusTotal}}</span>                               
                            </div>
                        </div>
                    </div>
                </a>
...
<section class="social-section">
    <div class="container">
        ...
        <div class="section-title">
            <h2>Nas Redes</h2>
            <div class="section-title-icon">
                <hr><span class="vue-twitter"></span><hr>
            </div>
        </div> 
